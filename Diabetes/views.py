...
def predict(request):
    ...
    rawdata = staticfiles_storage.path('diabetes.csv')
    ...
    return render(request,'index.html',{"predicted":y_pred[0],"exp1":exp1,"exp2":exp2,"exp3":exp3,"exp4":exp4,"exp5":exp5,"exp6":exp6,"exp7":exp7,"exp8":exp8})
